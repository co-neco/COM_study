...
HRESULT __stdcall 
RPNCalculatorFactory::QueryInterface(REFIID riid, void** ppvObject) {
	...
	if (riid == __uuidof(IUnknown)
		...
		*ppvObject = static_cast<RPNCalculatorFactory*>(this);
		return S_OK;
	}

	OutputDebugStringA("RPNCalculatorFactory");
...
HRESULT __stdcall RPNCalculatorFactory::CreateInstance(
	IUnknown* pUnkOuter,
	REFIID riid, 
	void** ppvObject)
{
